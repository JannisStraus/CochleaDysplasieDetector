...
from cochlea_detector.download import download_weights, resolve_release
from cochlea_detector.utils import BBox, save_bbox
...
def infer(
    ...
    models = load_models(weights_dir, resolve_release().n_folds)
